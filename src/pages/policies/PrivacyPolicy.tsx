  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <SEO 
        ...
        description="Learn how we collect, protect, and manage your personal data at Surabhi Loyalty League."
        keywords="privacy policy, data protection, surabhi privacy"
      />
