  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <SEO 
        ...
        description="Read our cancellation and refund policies for orders placed on the Surabhi Loyalty League shop."
        keywords="cancellation policy, refund policy, returns, refunds, order cancellation"
      />
